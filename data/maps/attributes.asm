...
ENDM
	...
	map_attributes PalletLake, PALLET_LAKE, $0f, WEST
	connection west, Route1, ROUTE_1, -6
	...
	map_attributes OlivinePharmacySpeechHouse, OLIVINE_PHARMACY_SPEECH_HOUSE, $00, 0
	...
	map_attributes LavenderPokemonRefuge, LAVENDER_POKEMON_REFUGE, $00, 0
