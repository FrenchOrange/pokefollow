...
; 	ThunderBadge: Speed
; 	SoulBadge:    Defense
; 	VolcanoBadge: Special Attack and Special Defense
...
; Swap badges 3 (ThunderBadge) and 6 (SoulBadge).
	ld d, a
	and (1 << THUNDERBADGE)
	add a
	add a
	...
	ld c, a
	ld a, d
	and ((1 << BOULDERBADGE) | (1 << CASCADEBADGE) | (1 << MARSHBADGE) | (1 << RAINBOWBADGE) | (1 << VOLCANOBADGE) | (1 << EARTHBADGE))
	or b
	or c
	ld b, a
