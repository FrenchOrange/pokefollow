...
CopycatsHouse2F_MapEvents:
	...
	def_object_events
	object_event  6,  4, SPRITE_DODRIO_STATIC, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CopycatsDodrio, -1
	...
	object_event  7,  1, SPRITE_FARFETCH_D, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, CopycatsHouse2FDoll, -1
