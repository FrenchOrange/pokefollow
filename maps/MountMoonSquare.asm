...
ClefairyDance:
	...
	cry CLEFAIRY
	applymovement MOUNTMOONSQUARE_CLEFAIRY1, ClefairyDanceStep2
	cry CLEFAIRY
	applymovement MOUNTMOONSQUARE_CLEFAIRY1, ClefairyDanceStep3
	cry CLEFAIRY
	applymovement MOUNTMOONSQUARE_CLEFAIRY1, ClefairyDanceStep4
	cry CLEFAIRY
	applymovement MOUNTMOONSQUARE_CLEFAIRY1, ClefairyDanceStep5
	stopfollow
	applymovement MOUNTMOONSQUARE_CLEFAIRY2, ClefairyDanceStep6
	follow MOUNTMOONSQUARE_CLEFAIRY1, MOUNTMOONSQUARE_CLEFAIRY2
	applymovement MOUNTMOONSQUARE_CLEFAIRY1, ClefairyDanceStep7
	stopfollow
