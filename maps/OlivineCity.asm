...
OlivineCityRivalSceneTop:
	...
	unfreezefollower
	applymovement OLIVINECITY_RIVAL, OlivineCityRivalStepRight
	...
	variablesprite SPRITE_RIVAL, SPRITE_SWIMMER_GUY
...
OlivineCity_MapEvents:
	...
	warp_event 33, 11, OLIVINE_PHARMACY_SPEECH_HOUSE, 1
