...
; Kanto story events
	...
	const EVENT_BLUE_CROWD
	const EVENT_PLAYER_CROWD
	const EVENT_MOM_AND_OAK_INVISIBLE
	const EVENT_GOT_STARTER_FROM_OAK
	const EVENT_ROUTE_1_PIDGEY
	const EVENT_MET_MISTY_PALLET_LAKE
	const EVENT_MISTY_BIKE_BORROWED
	const EVENT_MET_HOOH_ROUTE_1
	const EVENT_TALKED_TO_VIRIDIAN_JENNY
	const EVENT_MET_TEAM_ROCKET_VIRIDIAN
	const EVENT_VIRIDIAN_CITY_GYM_GUARDS
	const EVENT_PEWTER_MUSEUM_BOUGHT_TICKET
; vanilla
...
; Kanto hidden items
	const EVENT_VIRIDIAN_CITY_HIDDEN_ANTIDOTE
...
; Johto people
	...
	const EVENT_TALKED_TO_POKECENTER_RULES_RECEPTIONIST
...
; but in pokecrystal the 'const_next 1900' is redundant.)
	...
	const_next 1900
; Kanto people
	const EVENT_CAN_ACCESS_VIRIDIAN_GYM
